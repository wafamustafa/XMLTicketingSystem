...
for($i = 0; $i < sizeof($XMLhelpdesk); $i++){
    //if block to ensure SESSION ticket id = xml ticket id and SESSION employee id = employee id 
...
for($i = 0; $i < sizeof($ticket_details); $i++){
    ...
    if(isset($_POST['leaveComment'])){
        if (isset($_POST['messgaeBox']) !== ''){
            ...
            $comment_tag->addAttribute('id', $employee_id); //in staffview: changed to employee id
    ...
    <body>
        ...
        <main id="ticketdetail_div">
            ...
            <div class="ticket_discription">
                ...
                <!--everything is the same but the home button below-->
                <button class="account_btn"><a href="staff.php">Home</a></button>
            </div>
        </main>
    </body>
</html>